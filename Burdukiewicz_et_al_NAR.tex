...
Two implemented approaches, GLM and \testit{multiple testing} (\testit{MT}) were compared over 
...
The GLM approach used binomial model and \testit{MT} framework employed \textit{ratio test}.
