...
methods and plots into the \textit{dpcR} package, based on the sophisticated 
...
software can be used for data analysis and presentation, as frame-work for novel 
...
via a command-line interface. The \textit{dpcR} package can be used to build a 
custom-made analyser according to the wishes of the user. The \textit{dpcR} 
package is an open environment, which can be adopted to the growing knowledge in 
dPCR. 
...
mainstream user-base and will likely to have the same impact in nucleic acids 
quantification as real-time quantitative PCR \cite{huggett_qpcr_2015, morley_digital_2014, 
rodiger_r_2015}. There is currently an intensive research 
...
in the peer-review literature (Dube 2008, PLoS One, Bath …) \cite. The uncertainty is 
