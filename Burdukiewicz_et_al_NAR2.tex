...
of the concentration of a template in the sample ($c$) seems to be trivial ($ c 
= \lambda V $), yet methods of analysis of dPCR results are still emerging.
...
scattered efforts have limited use, since they are tied to a very specific 
problem and hard to incorporate into a single workflow.
