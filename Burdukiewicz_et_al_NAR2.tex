...
PARAGRAPH FOR METHODS

The variety of existing methods is disproportionate to the number of software 
packages dedicated to analysis of dPCR experiments. Most of the software is 
distributed by vendors of dPCR systems and directly tied to their hardware. 
The lack of an uniform framework hinders a comparison of results from different 
systems.
